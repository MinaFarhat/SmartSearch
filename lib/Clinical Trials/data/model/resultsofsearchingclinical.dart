...
class ResultsofsearchingclinicalEntity {
  @JsonKey(name: "data")
  final List<ResultsofsearchingclinicalData> resultsClinical;

  // Constructor
  ResultsofsearchingclinicalEntity(this.resultsClinical);

  factory ResultsofsearchingclinicalEntity.fromJson(
          Map<String, dynamic> json) =>
      _$ResultsofsearchingclinicalEntityFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ResultsofsearchingclinicalEntityToJson(this);
}
