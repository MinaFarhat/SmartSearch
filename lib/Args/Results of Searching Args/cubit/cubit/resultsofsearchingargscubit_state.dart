...
class ResultsofsearchingargscubitState with _$ResultsofsearchingargscubitState {
  ...
  const factory ResultsofsearchingargscubitState.success(
      ResultsofsearchingEntity resultsofsearchingentity) = _Success;
  const factory ResultsofsearchingargscubitState.error(
